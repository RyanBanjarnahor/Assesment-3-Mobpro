...
fun BarangDialog(
    ...
    var harga_barang by remember { mutableStateOf("") }
        ...
        Card(
            ...
            Column(
                ...
                Row(
                    ...
                    OutlinedButton(
                        onClick = { onConfirmation(nama_barang, harga_barang) },
                        enabled = nama_barang.isNotEmpty() && harga_barang.isNotEmpty(),
                        modifier = Modifier.padding(8.dp)
                    ) {
